...
export const metadata: Metadata = {
  title: 'Plumbing and HVAC Services | Sharp Plumbing | Independence, MO',
  description: 'Sharp Plumbing provides comprehensive plumbing, HVAC, and gas line services in Independence, MO. AC services, appliance installation, drain cleaning, water heaters, and more. Call (816) 207-3561.',
  openGraph: {
    title: 'Plumbing and HVAC Services | Sharp Plumbing',
    description: 'Comprehensive plumbing, HVAC, and gas line services in Independence, MO.',
    type: 'website',
  },
}
...
const serviceIcons: Record<string, React.ReactNode> = {
  ...
  'water-heater-and-treatment-services': (
    <svg className="w-8 h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24">
      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M19.428 15.428a2 2 0 00-1.022-.547l-2.387-.477a6 6 0 00-3.86.517l-.318.158a6 6 0 01-3.86.517L6.05 15.21a2 2 0 00-1.806.547M8 4h8l-1 1v5.172a2 2 0 00.586 1.414l5 5c1.26 1.26.367 3.414-1.415 3.414H4.828c-1.782 0-2.674-2.154-1.414-3.414l5-5A2 2 0 009 10.172V5L8 4z" />
    </svg>
  ),
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {serviceCategories.map((category) => (
              ...
              >
                ...
                <span className="inline-flex items-center text-sharp-blue font-semibold">
                  Learn More
      ...
      <section className="bg-gray-50 py-16 border-t border-gray-100">
        <div className="container-custom text-center">
          ...
          <p className="text-gray-600 max-w-2xl mx-auto mb-8">
            Contact Sharp Plumbing today for expert plumbing and HVAC services in the Independence, MO area.
            We offer free estimates, same-day services, and warranties on all work.
          </p>
